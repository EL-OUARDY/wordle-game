  ...
  ({ className, children, variant = "default", ...props }, ref) => {
    return (
      <button
        ...
        ref={ref}
        className={clsx(
          "inline-flex cursor-pointer items-center justify-center rounded-3xl px-8 py-2 text-center text-base capitalize transition-colors duration-300 select-none",
          variant === "default" &&
